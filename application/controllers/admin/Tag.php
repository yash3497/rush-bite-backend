...
class Tag extends CI_Controller
{
    ...
    public function delete_tag()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (is_exist(['tag_id' => $tag_id], 'partner_tags') || is_exist(['tag_id' => $tag_id], 'product_tags')) {
				$this->response['error'] = true;
                $this->response['message'] = 'This tag cannot be deleted because it is associated with partner or product data.';
