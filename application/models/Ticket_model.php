...
class Ticket_model extends CI_Model
{
    ...
    function get_ticket_list()
    {
        ...
        $search_res = $this->db->select('t.*,DATE(t.date_created) as date_created,tty.title,u.username')->join('ticket_types tty', 'tty.id=t.ticket_type_id', 'left')->join('users u', 'u.id=t.user_id', 'left');
