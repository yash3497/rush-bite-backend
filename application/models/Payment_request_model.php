...
class Payment_request_model extends CI_Model
{
    ...
    function get_payment_request_list($user_id = NULL)
    {
        ...
        $offer_search_res = $search_res->order_by($sort, $order)->limit($limit, $offset)->select('u.username,pr.*,DATE(pr.date_created) as date_created')->get('payment_requests pr')->result_array();
        $bulkData = array();
