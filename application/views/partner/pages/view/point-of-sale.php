                    ...
                    <div class="col-md-5">
                        <div class="card">
                            <section class="container content-section mt-4">
                                <form id="pos_form" method="post" action='<?= base_url('partner/point_of_sale/place_order') ?>'>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action='<?= base_url('partner/point_of_sale/register_user') ?>' id="register_form">
