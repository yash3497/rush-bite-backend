...
<div class="">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="text text-info">Partner Registration <span class='text-danger text-sm'>DO NOT REFRESH OR
    ...
    <section class="content">
        <div class="container-fluid">
            <form class="form-horizontal" action="<?= base_url('partner/auth/create_partner'); ?>" method="POST"
                id='sign_up_restro_form'>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="partner_name"
                                                    placeholder="Partner Name" name="partner_name">
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="cooking_time"
                                                    id="cooking_time" placeholder="Food Preparation Time in Minutes"
                                                    min="0">
                                            </div>
                                        </div>
                                        <!-- removed city -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="latitude">Latitude <span
                                                            class='text-danger text-sm'>*</span></label>
                                                    <input type="number" class="form-control" readonly name="latitude"
                                                        min="0" step="0.000000000000000001" id="city_lat"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="name"
                                                    placeholder="Restro Owner Name" name="name" <?= (isset($user_data) && !empty($user_data) && !empty($user_data['to_be_partner_id'])) ? 'disabled' : ''; ?>
                                                    value="<?= @$user_data['to_be_partner_name'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="mobile"
                                                    placeholder="Enter Mobile" name="mobile" <?= (isset($user_data) && !empty($user_data) && !empty($user_data['to_be_partner_id'])) ? 'disabled' : ''; ?>
                                                    value="<?= @$user_data['to_be_partner_mobile'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group ">
                        ...
                        <div class="card card-info">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            <label for="licence_name" class="col-sm-4 col-form-label">Licence
                                                Name</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="licence_name"
                                                    placeholder="Licence Name" name="licence_name"
                                                    value="<?= @$fetched_data[0]['licence_name'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="licence_code" class="col-sm-4 col-form-label">Licence
                                                Code</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="licence_code"
                                                    placeholder="Licence Code" name="licence_code"
                                                    value="<?= @$fetched_data[0]['licence_code'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="licence_proof" class="col-sm-3 col-form-label">Licence Proof
                                            </label>
                                            <div class="col-sm-10">
                                                <span class="text-danger">*Leave blank if there is no change</span>
